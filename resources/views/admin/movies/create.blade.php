...
<head>
    ...
    <title>Add New Movie - FastMovie Renesse</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-secondary">Add New Movie</h1>
                    <p class="text-gray-600 mt-2">Fill in the details to add a new movie</p>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="age_rating" id="age_rating" required
                            ...
                            <option value="All" {{ old('age_rating') == 'All' ? 'selected' : '' }}>All</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Recommended size: 300x450px (JPG, PNG)</p>
                        @error('poster_image')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
